...
struct CppTokenNodeType : TokenNodeType
{
    CppTokenNodeType(const char* s)
    { }
};

struct CppTokenNodeTypes sealed
{

#define TOKEN_NODE_TYPE(NAME, TEXT) \
    static inline CppTokenNodeType* const NAME = new CppTokenNodeType(#NAME)
...
#define PUNCTUATOR_ALT_TOKEN_NODE_TYPE(NAME, TEXT, ALT_TEXT) \
    ...
    static inline TokenNodeType* const MODIFICATION_UTIL_MARKER = CONDITIONALLY_NOT_COMPILED_CODE;
